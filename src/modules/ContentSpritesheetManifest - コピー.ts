...
export interface ISpritesheetJsonData {
	frames: [name: string]: {
		[name: string]: any;
	},
	meta: [name: string]: {
...
export class ContentSpritesheetManifest extends ContentManifestBase<string | ISpritesheetJsonData, PIXI.ITextureDictionary> {
	/**
