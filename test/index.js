...
describe('Pixim.js', () => {
	...
	describe('Content', () => {
		it('define and add images', () => {
			return new Promise((resolve, reject) => {
				...
				Test.defineImages({
					...
					absolute: path.resolve("c:/xampp/htdocs/Pixim.js/test", 'img/image_1.png?asdads'),
		...
		it('unrequire define and add jsons', () => {
			return new Promise((resolve, reject) => {
				const app = new Pixim.Application();
	...
	describe('Loader', () => {
		it('texture', () => {
			...
			const l = new Pixim.TextureLoader({ basepath: __dirname })
			return l.loadAsync('img/image_1.png')
				.then(resource => {
					res.push(resource)
		...
		it('textures', () => {
			return new Pixim.TextureLoader({ basepath: __dirname })
				.loadAllAsync({
					relative: 'img/image_1.png',
		...
		it('spritesheet', () => {
			...
			const l = new Pixim.SpritesheetLoader({ basepath: __dirname })
			return l.loadAsync('img/ss_1.json')
				.then(resource => {
					res.push(resource)
		...
		it('spritesheets', () => {
			return new Pixim.SpritesheetLoader({ basepath: __dirname })
				.loadAllAsync({
					relative: 'img/ss_1.json',
					absolute: path.resolve(__dirname, 'img/ss_1.json'),
					json: {"frames":{"ss_1_1":{"frame":{"x":4,"y":110,"w":102,"h":102},"rotated":false,"trimmed":false,"spriteSourceSize":{"x":0,"y":0,"w":102,"h":102},"sourceSize":{"w":102,"h":102}},"ss_1_2":{"frame":{"x":4,"y":4,"w":102,"h":102},"rotated":false,"trimmed":false,"spriteSourceSize":{"x":0,"y":0,"w":102,"h":102},"sourceSize":{"w":102,"h":102}}},"meta":{"app":"Adobe Animate","version":"19.2.1.408","image":"data:image/png;base64,","format":"RGBA8888","size":{"w":256,"h":256},"scale":"1"}}
		...
		it('sound', () => {
			...
			const l = new Pixim.SoundLoader({ basepath: __dirname })
			return l.loadAsync('sound/a.mp3')
				.then(resource => {
					res.push(resource)
		...
		it('sounds', () => {
			return new Pixim.SoundLoader({ basepath: __dirname })
				.loadAllAsync({
					relative_a: 'sound/a.mp3',
					absolute_a: path.resolve(__dirname, 'sound/a.mp3'),
					data_a: 'data:audio/mp3;base64,'
		...
		it('json', () => {
			...
			const l = new Pixim.JsonLoader({ basepath: __dirname })
			return l.loadAsync('data/1.json')
				.then(resource => {
					res.push(resource)
